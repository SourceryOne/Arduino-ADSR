void menu3() {
  ...
  */
  ...
  //moduleMode=map(menu1Mode, 0, 1023, 0, 6); THIS WOULD WORK AGAIN NOW, BUT ALREADY DID BELOW, WHICH IS PROBABLY MORE EFFIECENT...
       ...
       if (menu1Mode<=170) {moduleMode=0; menuLeds(2,2,2,2); }      //Dual ADSR, yyyy. should be ggrr no?
  ...
  else if (menu1Mode<=512) {moduleMode=2; menuLeds(2,0,3,1); } //2 input 2 ADSR 1 output (ADSR1 och ADSR2 on same output... this is like the Accented one but they would interfere...? - green yellow red 0
